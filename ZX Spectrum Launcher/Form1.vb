...
Public Class Form1
    Dim GameFolder As String = "C:\ZXSpectrum48k\Games\Retail"
    Dim ImageFolder As String = "C:\ZXSpectrum48k\Images"
    Dim ManualFolder As String = "C:\ZXSpectrum48k\Manuals"
    ...
    Private Sub BtnLoadGame_Click(sender As Object, e As EventArgs) Handles BtnLoadGame.Click
        ...
        If Not String.IsNullOrEmpty(gameFile) Then
            Try
                ...
                startInfo.FileName = Path.Combine(Directory.GetCurrentDirectory(), "python", "python.exe") ' Use embedded Python
                startInfo.Arguments = """" & Path.Combine(Directory.GetCurrentDirectory(), "tzxplay.py") & """ """ & gameFile & """" ' Correct tzxplay.py path
